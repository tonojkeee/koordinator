...
Features:
- Redis pub/sub for cross-process messaging (multi-worker support)
- Parallel message broadcasting with asyncio.gather
- Automatic fallback to in-memory when Redis unavailable
- Session tracking via Redis for persistence
"""
